...
if(isset($_POST['submit'])){
    ...
    $resultadoTowersTeam1 = mysqli_query($conn, $sqlTowersTeam1);
    $resultadoTowersTeam2 = mysqli_query($conn, $sqlTowersTeam2);
    ...
    && mysqli_num_rows($resultadoTowersTeam1) > 0 && mysqli_num_rows($resultadoGamelength) > 0) {
        ...
        echo "Média de dragons: " . round(($averageDragonsTeam1 + $averageDragonsTeam2),2) .
         ...
         . " | Média de towers: " . round($averageTowersTeam1 + $averageTowersTeam2, 2) . " | Média de tempo: " . $averageMinutes . " minutos " . $averageSecondsRound . " segundos";
    } else {
