...
<div class="container">
<form method="post" action="scripts/queryAllDragons.php" class="dark-form">
...
<form method="post" action="scripts/queryAllTowers.php" class="dark-form">
...
<form method="post" action="scripts/queryAllKills.php" class="dark-form">
    <label for="objective">kills per game</label>
    <label for="league">League</label>
    <input type="text" id="league" name="league">
    <input type="submit" name="submit" id="submit" value="enviar">
</form>
...
<form method="post" action="scripts/queryAllTime.php" class="dark-form">
    <label for="objective">All time per game</label>
    <label for="league">League</label>
    <input type="text" id="league" name="league">
    <input type="submit" name="submit" id="submit" value="enviar">
</form>
